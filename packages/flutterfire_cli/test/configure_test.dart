...
void main() {
  ...
  group('FlutterFire configure tests - no build', () {
    ...
    test(
        'flutterfire configure: incorrect `--web-app-id` should throw exception',
        () async {
      final result = Process.runSync(
        'flutterfire',
        [
  ...
  group('FlutterFire configure tests - build target (iOS 15.0)', () {
    ...
    test(
      ...
      () async {
        ...
        buildArgs.add('--device-id=98641507-FA54-4F7C-BBE9-4970C7C0EB55');
