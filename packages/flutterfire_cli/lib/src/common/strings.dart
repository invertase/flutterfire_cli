...
/// Logs when a hand written `firebase-messaging-sw.js` is found in `web/`.
String logSkippingExistingWebMessagingServiceWorker(String serviceWorkerPath) =>
    ...
    '${serviceWorkerPath.cyan} already exists and was not generated by '
    'FlutterFire CLI. Update the Firebase configuration in it yourself, or '
